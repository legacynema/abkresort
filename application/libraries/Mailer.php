...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'dzikrialif99@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'ABKRESORT | Reservasi Liburan'; // Isikan dengan nama pengirim
    protected $password = 'snugpcgvyprwjxbh'; // Isikan dengan password email pengirim
