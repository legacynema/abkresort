...
<body>
    <div class="enigma_header_breadcrum_title">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Destinasi Wisata Di kota Bandung</h1>
                </div>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <img src="<?= base_url('assets/') ?>img/bandung2.jpg"  class="d-block w-100" height="100%"  alt="">
            </div>
            <div class="col-md-2"></div>
    </div>
        ...
        <div class="block post inset-on-m">
            <div class="block post__item bzg" style>
                ...
                <div class="bzg_c" data-col="m4">
                    ...
                    <img src="<?= base_url('assets/') ?>img/gedungsate.jpg" alt="" class="">
                    </a> 
                    </figure>
                </div>
            ...
            <div class="block post__item bzg" style>
                <h3 class="bzg_c block--small "style>
                    <a href="#" class="link-black t--larger"style>Gunung Tangkuban Perahu</a>
                </h3>
                <div class="bzg_c col-md-4" >
                    <img src="<?= base_url('assets/') ?>img/tangkubanperahu.jpg" alt="">
                </div>
